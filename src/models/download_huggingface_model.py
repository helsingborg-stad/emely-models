...
def main(args):
    ...
    model_dir = Path(__file__).resolve().parents[2] / 'huggingface-models' / model_name / 'model'
    token_dir = Path(__file__).resolve().parents[2] / 'huggingface-models' / model_name / 'tokenizer'
